...
@Controller
//Component가 들어있음(Repository,Service 등) ->컴포넌트 스캔과 자동 의존관계 설정
...
public class MemberController {
  ...
  @Autowired
  //autowired는 springContainer에서 memberService를 가져옴
...
//  }
  ...
  public String create(MemberForm form){
    ...
    //System.out.println("member = " + member.getName()); //입력한 name값
